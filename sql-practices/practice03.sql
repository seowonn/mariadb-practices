...
select a.emp_no, a.last_name, c.dept_name from employees a
...
SELECT a.emp_no, a.last_name, b.salary, c.title, e.dept_name FROM employees a
...
SELECT a.emp_no, a.last_name FROM employees a
...
-- 고려사항: titles, dept_emp에서 중복 emp_no 존재. -> 현재 근무 중인 직원으로 우선 제한
SELECT a.emp_no, a.last_name, c.dept_name, d.title FROM employees a
	JOIN dept_emp b ON b.emp_no = a.emp_no
	JOIN departments c ON c.dept_no = b.dept_no
...
SELECT a.emp_no, a.last_name, b.salary, c.title FROM employees a
	JOIN salaries b ON b.emp_no = a.emp_no
	JOIN titles c ON c.emp_no = a.emp_no
WHERE b.to_date > current_date()
	AND b.salary >= 40000
